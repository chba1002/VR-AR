...
public class OVRControllerTest : MonoBehaviour
{
	...
	void Start()
	{
		...
		monitors = new List<BoolMonitor>()
		{
			...
			new BoolMonitor("OneDown",                          () => OVRInput.GetDown(OVRInput.GetButtonDown.One)),
			new BoolMonitor("OneUp",                            () => OVRInput.GetUp(OVRInput.GetButtonDown.One)),
			...
			new BoolMonitor("Two",                              () => OVRInput.Get(OVRInput.GetButtonDown.Two)),
			new BoolMonitor("TwoDown",                          () => OVRInput.GetDown(OVRInput.GetButtonDown.Two)),
			new BoolMonitor("TwoUp",                            () => OVRInput.GetUp(OVRInput.GetButtonDown.Two)),
			new BoolMonitor("PrimaryIndexTrigger",              () => OVRInput.Get(OVRInput.GetButtonDown.PrimaryIndexTrigger)),
			new BoolMonitor("PrimaryIndexTriggerDown",          () => OVRInput.GetDown(OVRInput.GetButtonDown.PrimaryIndexTrigger)),
			new BoolMonitor("PrimaryIndexTriggerUp",            () => OVRInput.GetUp(OVRInput.GetButtonDown.PrimaryIndexTrigger)),
			...
			new BoolMonitor("PrimaryHandTrigger",               () => OVRInput.Get(OVRInput.GetButtonDown.PrimaryHandTrigger)),
			new BoolMonitor("PrimaryHandTriggerDown",           () => OVRInput.GetDown(OVRInput.GetButtonDown.PrimaryHandTrigger)),
			new BoolMonitor("PrimaryHandTriggerUp",             () => OVRInput.GetUp(OVRInput.GetButtonDown.PrimaryHandTrigger)),
			new BoolMonitor("Up",                               () => OVRInput.Get(OVRInput.GetButtonDown.Up)),
			new BoolMonitor("Down",                             () => OVRInput.Get(OVRInput.GetButtonDown.Down)),
			new BoolMonitor("Left",                             () => OVRInput.Get(OVRInput.GetButtonDown.Left)),
			new BoolMonitor("Right",                            () => OVRInput.Get(OVRInput.GetButtonDown.Right)),
